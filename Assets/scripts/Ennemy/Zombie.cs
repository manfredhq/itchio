...
using UnityEngine;
using Pathfinding;
public class Zombie : MonoBehaviour, IEnnemy
{
    ...
    List<GameObject> IEnnemy.loot { get => loot; set => loot = value; }
    Transform IEnnemy.player { get => player; set => player = value; }
    float IEnnemy.moveSpeed { get => moveSpeed; set => moveSpeed = value; }
    Rigidbody2D IEnnemy.rb { get => rb; set => rb = value; }
    Vector2 IEnnemy.movement { get => movement; set => movement = value; }
    int IEnnemy.hp { get => hp; set => hp = value; }
    int IEnnemy.damage { get => damage; set => damage = value; }
    int IEnnemy.xpDrop { get => xpDrop; set => xpDrop = value; }
